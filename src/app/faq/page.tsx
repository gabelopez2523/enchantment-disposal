  ...
  return (
    <section className="min-h-screen p-4 sm:p-6 md:p-8 max-w-7xl mx-auto flex-col bg-white">
      <div className="w-full bg-[#BF0A30] py-6 sm:py-8 px-4 mb-6 text-center rounded text-white">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white">Frequently Asked Questions</h1>
      </div>

      <div className="space-y-6 sm:space-y-8">
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 mb-2">What items are prohibited from disposal?</h2>
        ...
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 mb-2">How long is the standard dumpster rental period?</h2>
        ...
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 mb-2">What is included in the dumpster rental price?</h2>
          <p className="text-sm sm:text-base text-gray-700">
        ...
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 mb-2">How soon can I schedule a dumpster delivery?</h2>
          <p className="text-sm sm:text-base text-gray-700">
        ...
        <div>
          <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-gray-700 mb-2">Do I need a permit for my dumpster?</h2>
          <p className="text-sm sm:text-base text-gray-700">
