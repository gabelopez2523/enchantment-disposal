...
export default function AboutPage() {
  return (
    <section className="min-h-screen p-8 max-w-7xl mx-auto flex-col bg-white">
      <div className="w-full bg-[#BF0A30] py-8 px-4 mb-6 text-center rounded text-white">
        <h1 className="text-4xl font-bold text-white">About Enchantment Disposal</h1>
      </div>
      ...
      <h2 className="text-2xl font-semibold text-green-700 mb-2">Licenses & Certifications</h2>
